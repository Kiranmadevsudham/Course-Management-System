 ...
 * @author achyu
 */
public class PostCourseInfo extends JFrame implements ActionListener{
JFrame f;
JLabel l1,l2,l3;
JTextField t1,t2,t3;
...
public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(!rs1.next()){
                ...
                String q2 = "insert into courseinfo values('"+cid+"','"+sb+"')";
   ...
   public static void main(String[] arg){
        PostCourseInfo l = new PostCourseInfo();
    }  
