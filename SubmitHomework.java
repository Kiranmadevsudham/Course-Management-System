 ...
 * @author aparna
 */
public class SubmitHomework extends JFrame implements ActionListener {
JFrame f;
JLabel l1,l2,l3;
JTextField t1,t2,t3;
...
SubmitHomework()
 {
   ...
   public static void main(String[] arg){
        SubmitHomework l = new SubmitHomework();
    }  
   ...
   public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(!rs1.next()){
                ...
                String q2 = "insert into homework values('"+cid+"','"+sb+"')";
