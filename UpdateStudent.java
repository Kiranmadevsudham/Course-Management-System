...
class UpdateStudent implements ActionListener{
    ...
    UpdateStudent(){;
        ...
        JLabel l1 = new JLabel("Enter srn number to update the data of student");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                String str = "update student set name='"+t1.getText()+"',email='"+t2.getText()+"',srn='"+t3.getText()+"', phone='"+t4.getText()+"',course='"+t5.getText()+"',branch='"+t6.getText()+"' where srn='"+t12.getText()+"'";
        ...
        if(ae.getSource() == b2){
            try{
                conn con = new conn();
                String str = "select * from student where srn = '"+t12.getText()+"'";
