...
class UpdateTeacher implements ActionListener{
    ...
    UpdateTeacher(){
        ...
        JLabel l1 = new JLabel("Enter emp id to update the data of teacher");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                conn con = new conn();
                         String str = "update teacher set name='"+t1.getText()+"',empid='"+t2.getText()+"',email='"+t3.getText()+"', phone='"+t4.getText()+"',course='"+t5.getText()+"',branch='"+t6.getText()+"' where empid='"+t12.getText()+"'";
        ...
        if(ae.getSource() == b2){
            try{
                conn con = new conn();
                String str = "select * from teacher where empid = '"+t12.getText()+"'";
